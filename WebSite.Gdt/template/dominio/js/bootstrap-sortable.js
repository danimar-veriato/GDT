...
function DomSgeSortable() {
    ...
    (function ($) {
        ...
        $document.on('click', 'table.sortable thead th[data-defaultsort!="disabled"]', function (e) {
            ...
            doSort($this, $table);
            //ordem = $this.text();
            ordem = $this.attr('colunaDb');
            //alert(ordem);
            document.cookie = "colCrmn0001=" + ordem + "; path=/";
        ...
        function doSort($this, $table) {
            ...
            if (bsSort[sortKey] == 'desc') {
                //alert(bsSort[sortKey]);                
                $this.find('span.sign').addClass('up');
                document.cookie = "ordCrmn0001=desc; path=/";
            }
            else {
                document.cookie = "ordCrmn0001=asc; path=/";
            }
